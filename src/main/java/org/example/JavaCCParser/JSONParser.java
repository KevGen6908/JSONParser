...
public class JSONParser/*@bgen(jjtree)*/implements JSONParserTreeConstants, JSONParserConstants {/*@bgen(jjtree)*/
  ...
  public Object parse() throws ParseException {/*@bgen(jjtree) parse */
...
if (jjtc000) {
  ...
  final protected Map _object() throws ParseException {/*@bgen(jjtree) _object */
...
if (jjtc000) {
  ...
  final protected void members(Map m) throws ParseException {/*@bgen(jjtree) members */
...
if (jjtc000) {
  ...
  final protected void pair(Map m) throws ParseException {/*@bgen(jjtree) pair */
...
if (jjtc000) {
  ...
  final protected String fieldName() throws ParseException {/*@bgen(jjtree) fieldName */
...
if (jjtc000) {
  ...
  final protected List _array() throws ParseException {/*@bgen(jjtree) _array */
...
if (jjtc000) {
  ...
  final protected void elements(List a) throws ParseException {/*@bgen(jjtree) elements */
...
if (jjtc000) {
  ...
  final protected Object value() throws ParseException {/*@bgen(jjtree) value */
